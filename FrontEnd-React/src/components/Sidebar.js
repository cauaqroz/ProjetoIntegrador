    ...
    <div className="sidebar">
      ...
      <ul>
        <li className={currentTab === '/inicial' ? 'active' : ''}>
          <Link to="/inicial" onClick={() => setCurrentTab('/inicial')}>Inicial</Link>
        </li>
        ...
        <li className={currentTab === '/Perfil' ? 'active' : ''}>
          <Link to="/Perfil" onClick={() => setCurrentTab('/Perfil')}>Perfil</Link>
        </li>
        <li className={currentTab === '/configuracoes' ? 'active' : ''}>
          <Link to="/configuracoes" onClick={() => setCurrentTab('/configuracoes')}>Configurações</Link>
        </li>
      </ul>
    </div>
  );
